                ...
                <div className="grid grid-cols-3 space-x-20">
                    ...
                    <div className="col-span-2 flex justify-center items-center">
                        <div>
                            ...
                            <a href="/admin/courses/skcet" className="inline-flex text-white bg-violet-600 hover:bg-violet-800 hover:px-5 px-3 py-2 rounded-lg font-medium text-center focus:ring-4 focus:outline-none">
