...
import { getCoursesByInstitute } from "../../services/course";
...
function Courses() {  
  ...
  const instituteId = useSelector(state => state.auth.institute);
  ...
  useEffect(() => {
    async function fetchCourses() {
      try {
        ...
        const response = await getCoursesByInstitute("6e0caaec-61b8-48ba-b609-6a287c6c0b60");
