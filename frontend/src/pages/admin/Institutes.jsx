    ...
    <div className="bg-violet-200 min-h-screen p-12">
      ...
      
      {
        formVisibility && (
          ...
          <div className="bg-white sborder-2 border-black w-[90%] h-fit p-5 rounded-xl flex flex-col items-center">
            <h1 className="text-2xl font-bold mb-3">Add Institute</h1>

            <div className="w-full p-5 mb-2 rounded-xl flex flex-col space-y-3">
              <div className="flex flex-col">
                <label
                  htmlFor="instName"
                  className="tracking-tighter text-sm mb-1 pl-0.5"
                >
                  Institute Name
                </label>
                <input
                  type="text"
                  id="instName"
                  className="b-2 text-sm text-gray-900 rounded-md p-1.5 border-2 border-gray-600 "
                ></input>
              </div>
              ...
              <div className="flex flex-col">
                ...
                <textarea
                  id="instLocation"
                  className="b-2 text-sm text-gray-900 rounded-md p-1.5 border-2 border-gray-600 min-h-9"
                ></textarea>
              </div>
              ...
              <div className="flex flex-col">
                <label
                  ...
                  className="tracking-tighter text-sm mb-1 pl-0.5"
                >
                  A few lines about your institution
                </label>
                <textarea
                  id="instAbout"
                  className="b-2 text-sm text-gray-900 rounded-md p-1.5 border-2 border-gray-600 min-h-9"
            ...
            <button
              type="submit"
              className="bg-green-600 hover:bg-green-800 hover:px-3 text-white p-2 tracking-tighter rounded-lg mt-3"
            >
              Add Institute
            </button>
          </div>
