...
function CourseDetail() {
    ...
    return (
        <div className="bg-violet-200 p-12 min-h-fit ">
                ...
                <div className="col-span-2 flex justify-center items-center">
                    <div>
                        ...
                        <div className="space-x-2">
                            <button className="inline-flex text-white bg-violet-600 hover:bg-violet-800 hover:px-5 px-3 py-2 rounded-lg font-medium text-center focus:ring-4 focus:outline-none">
                                Download Syllabus
            ...
            {
                formVisibility && (
                    <form className="fixed top-0 left-0 w-full h-full bg-opacity-0 bg-black backdrop-blur-md py-20 pb-36 mt-20 flex justify-center font-Poppins overflow-auto">
                    <div className="bg-violet-200 border-2 border-black w-[90%] h-fit p-5 rounded-xl flex flex-col items-center">
                        ...
                        <div className="flex flex-col">
                            ...
                            <select type="text" id="crsLevel" className="b-2 text-sm bg-violet-200 text-gray-900 rounded-md p-1.5 border-2 border-gray-600 ">
                        ...
                        <div className="flex flex-col">
                            ...
                            <input type="file" id="crsSyllabus" accept=".pdf" className="b-2 text-sm bg-violet-200 text-gray-900 rounded-md p-1.5 border-2 border-gray-600 "></input>
                        </div>
