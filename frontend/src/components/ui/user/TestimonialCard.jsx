...
function TestimonialCard({review, incrementButton, decrementButton,})
 {
  return (

    <div className="Card bg-white sm:w-[60%] w-[90%] z-20 rounded-md relative shadow-md shadow-slate-200 ring-violet-40 flex flex-col ">
      <div>
      <img
        alt="Error 🥺"
        src={review.image}
     ...
     <div className='sm:absolute mt-3 sm:top-6 left-[40%] leading-loose'>
      ...
      <div>
      <p className="description w-[75%] mx-auto leading-7 my-4 text-slate-500">{review.text}</p>
      </div>
...
TestimonialCard.propTypes = {
  ...
  decrementButton: PropTypes.func.isRequired,
};
