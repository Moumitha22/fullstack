...
function CourseCard({course,onViewCourse}) {
    return (
        <div className="w-full max-w-md mx-auto bg-white border border-gray-200 rounded-xl shadow-lg m-5 overflow-hidden">
            <div className="p-5">
                <div className="mb-4">
                    <h3 className="text-xl font-bold text-gray-800 mb-2 hover:text-violet-600">B.E {course.courseName}</h3>
                    <p className="text-sm font-medium text-gray-600">{course.instituteName}</p>
                </div>
                <div className="flex justify-between items-center">
                    <p className="text-sm font-normal text-gray-600">{course.noOfSemesters} Semesters/ {course.duration} Years</p>
                </div>
                <div className="mt-4 flex justify-center space-x-8"> 
                    <button onClick={onViewCourse} className="inline-flex items-center justify-center px-4 py-2 text-sm font-medium text-white bg-violet-500 rounded-md hover:bg-violet-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-violet-500">
                        Explore
                    ...
                    <button className="inline-flex items-center justify-center px-4 py-2 text-sm font-medium text-white bg-violet-500 rounded-md hover:bg-violet-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-violet-500">
                        Delete
