    ...
    <div className="max-w-sm bg-white border border-gray-200 rounded-xl shadow-lg m-5">
      ...
      <div className="p-5 font-[Poppins]">
        ...
        <div className="flex justify-center space-x-8">
          <a href="/admin/institute/6" className="inline-block bg-violet-500 hover:bg-violet-600 text-white px-6 py-2 rounded-lg transition duration-300 ease-in-out transform hover:-translate-y-1 hover:shadow-xl focus:outline-none focus:ring-4 focus:ring-violet-200">
